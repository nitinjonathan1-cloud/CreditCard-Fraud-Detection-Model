...
<img width="775" height="386" alt="image" src="https://github.com/user-attachments/assets/a557eeb4-3e4a-4148-84be-315fe7436a61" />

🗂️ Project Structure


⚙️ How It Works
Load dataset from fraudTest.csv
Explore the data (EDA), handle class imbalance if any
Train models (RandomForest, LogisticRegression, XGBoost)
Save the best model as fraud_detection_pipeline.pkl
Use main.py to load the model and predict on new inputs
app.py provides a web interface using Streamlit
💻 Example Usage (CLI)
...
🖼️ App Screenshot
Here is a preview of the Credit Card Fraud Detection app: App Screenshot
...
Shows class imbalance (fraud vs. genuine). Class Distribution of Transactions

💰 Transaction Amount Distribution
Understanding how transaction amounts vary. Transaction Amount Distribution

🛍️ Fraud by Category
Where fraud occurs based on merchant category. Fraud by Category

🗺️ Fraud by State
Geographical view of fraudulent transactions. Fraud by State
...
📉 ROC-AUC Curve
Model's ability to distinguish fraud from normal. ROC-AUC Curve
